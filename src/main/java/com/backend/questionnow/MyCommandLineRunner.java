...
public class MyCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Answer answer1 = new Answer("Lorem ipsum dolor sit amet",1L,2L,20);
        Answer answer2 = new Answer("Lorm dolor sit amet",2L,3L,20);
        Answer answer3 = new Answer("Lorem ipsum dolor sit amet",1L,null,3);
        Answer answer4 = new Answer("Lorem ipsum dolor sit amet",2L,null,50);
        Answer answer5 = new Answer("Loamet",1L,null,40);
        Answer answer6 = new Answer("Lorem ipsum dolor sit amet",2L,null,10);
        Answer answer7 = new Answer("Nirem ipsum dolor sit e",2L,null,5);
        Answer answer8 = new Answer("Nvrem ipsum dolor sit ie",2L,null,81);
        Answer answer9 = new Answer("Nie",2L,null,21);
        Answer answer10 = new Answer("Nie",2L,null,23);
        Answer answer11 = new Answer("Nie",2L,null,75);
        Answer answer12 = new Answer("Nie",3L,null,75);

        question1.getAnswerList().add(answer1);
        question1.getAnswerList().add(answer2);
        question1.getAnswerList().add(answer12);
